...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/admin_shared.css')}}">
  <style>
  .content-wrapper{
    background: #FFF;
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="invoice-header">
      <div class="float-left site-logo">
        <img src="{{ asset('images/logo_2.svg') }}" alt="">
      </div>
      <div class="float-right site-address">
        <h4>Lara Ecommerce</h4>
        <p>553/15 Mirpur Dhaka-15122, Bangladesh</p>
        <p>Phone: <a href="">01723000000</a></p>
        <p>Email: <a href="mailto:info@laracom">info@laracom.com</a></p>
      </div>
